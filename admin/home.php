...
<html>
<head>
<title>Info Tech Titan Information System</title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
    ...
    <div class="w3-container">
    <h1><b>WELCOME TO INFO TECH TITAN CLUB</b></h1>
     <div class="container">
	 
	 <div class="w3-container w3-padding-large" style="margin-bottom:32px">
  <header id="about">
    <h4><b>Info Tech Titan Club</b></h4>
  ...
  <!-- Images of Me -->
  <div class="w3-row-padding w3-padding-16" id="activity">
    <div class="container">
    <?php
    if (isset($_GET["msg"])) {
      $msg = $_GET["msg"];
	...
	<p align="center"><h3>Activities form Info Tech Titan</h3></p>
	<header id="activity">
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+jjXkk+Q2h455rYXK/7HAuoJl+0I4" crossorigin="anonymous"></script>
   ...
   <div class="container">
    ...
    ?>
	<p align="center"><h3>INFO TECH TITAN SYSTEM CLUB's COLLABORATION</h3></p>
